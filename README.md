...
The file **`main_fe.m`** implements the **DepHDP-m** and **DepHDP-r** algorithm (*Dep endency-aware Heterogeneous Data Perturbation*) proposed in the paper. DepHDP is a framework for multi-attribute mDP that combines dependency-aware grouping with heterogeneous perturbation design.
