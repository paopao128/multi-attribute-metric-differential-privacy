...
for i=1:length(cost_attribute)
 ...
 Srad_val
save('result/result-2/Srad_val.mat','Srad_val');
...
Smse_val
save('result/result-2/Smse_val.mat','Smse_val');
%%
...
epsilon_value=0.2:0.2:10; % 100
save('result/result-2/epsilon_value.mat','epsilon_value');
...
load("result/result-2/cost_attribute.mat")
load("result/result-2/distance_all_attributes.mat")
load("result/result-2/loss_table.mat")
loss_table_ori=loss_table;
save('result/result-2/loss_table_ori.mat','loss_table_ori');
...
for attribute_id=1:length(cost_attribute)
    loss_table{1,attribute_id}=loss_table{1,attribute_id}/length(cost_attribute{1,attribute_id});
...
save('result/result-2/loss_eval_upper.mat','loss_eval_upper');
save('result/result-2/loss_eval_lower.mat','loss_eval_lower');