...
loss_real_r_2=zeros(length(epsilon_allocation_lower),1);
for epsilon_id=1:length(epsilon_allocation_lower)
    epsilon_allocat=epsilon_allocation_lower(epsilon_id,:);
    % method_obfus=[1,1,1,3]; 
    threshold_adj=[0.2, 0.125, 0.02, 0.15, 0.6];
    ...
    loss_real_r_2(epsilon_id,1)=loss_set1+loss_set2+loss_set3+loss_set4+loss_set5+loss_set6;
end
...
% end
% %save('result/result-t/loss_benchmark_r.mat','loss_benchmark_r');
save('result/result-t/loss_real_r_2.mat','loss_real_r_2');