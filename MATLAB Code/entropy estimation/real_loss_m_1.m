...
loss_real_m_1=zeros(length(epsilon_allocation_upper),1);
for epsilon_id=1:length(epsilon_allocation_upper)
    ...
    %     end
    % end
    loss_real_m_1(epsilon_id,1)=loss_set1+loss_set2+loss_set3+loss_set4;
end
...
save('result/result-2/loss_real_m.mat','loss_real_m_1');