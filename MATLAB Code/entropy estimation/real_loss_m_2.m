...
save('result/result-2/loss_lower_m.mat','loss_lower_m');
%% use epsilon_allocation upper
threshold_adj=[1.2, 0.125, 0.02, 0.15];
loss_real_m_2=zeros(length(epsilon_allocation_upper),1);
for epsilon_id=1:length(epsilon_allocation_upper)
    ...
    %     end
    % end
    loss_real_m_2(epsilon_id,1)=loss_set1+loss_set2+loss_set3+loss_set4;
end
...
% end
% save('result/result-2/loss_benchmark_m.mat','loss_benchmark_m');
save('result/result-2/loss_real_m.mat','loss_real_m_2');