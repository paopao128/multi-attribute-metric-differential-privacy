...
load("result/result-t/Smse_val.mat")
...
save('result/result-t/loss_lower_m.mat','loss_lower_m');
...
for epsilon_id=1:length(epsilon_allocation_upper)
    ...
    loss_real_m_2(epsilon_id,1)=loss_set1+loss_set2+loss_set3+loss_set4+loss_set5+loss_set6;
end
...
% end
% save('result/result-t/loss_benchmark_m.mat','loss_benchmark_m');
save('result/result-t/loss_real_m.mat','loss_real_m_2');