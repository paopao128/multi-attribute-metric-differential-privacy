...
for i_sample=1:num_sample
    ...
    [Smse, nrmse, rmse] = mse_likeness_score_from_matrices(C, D, ...
        'IgnoreDiagonal', true, ...
        'IgnoreZeroR', false, ...
        'Delta', 1e-8);
    loss_pre_EM(i_sample,1) = cal_loss_EM(1,D,C);  
    Smse_sample(i_sample,1)=Smse;
...
plot(Smse_sample, loss_diff_ratio, 'o', 'MarkerSize', 8, 'MarkerFaceColor', 'b');
[R, P] = corr(Smse_sample(:), loss_diff_ratio(:), 'Type', 'Pearson');
save('figure 5/Smse_loss/Smse_sample.mat','Smse_sample');
save('figure 5/Smse_loss/loss_diff_ratio.mat','loss_diff_ratio');
save('figure 5/Smse_loss/R.mat','R');