...
for sample_id=1:num_sample
    ...
    training_cut;
    loss_set4(sample_id,1)=(overall_accuracy_ori-overall_accuracy)/overall_accuracy_ori*100000;
    ...
    training_cut;
    loss_set_all(sample_id,1)=(overall_accuracy_ori-overall_accuracy)/overall_accuracy_ori*100000;
