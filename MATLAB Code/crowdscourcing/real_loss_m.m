clear;
clc;
load("result/result-6/loss_table.mat")
load("result/result-6/distance_all_attributes.mat")
load("result/result-6/cost_attribute.mat")
load("result/result-6/Smse_val.mat")
%%
...
epsilon_value=0.04:0.04:10;
method_obfus=[2,2,2,2];
%%
...
save('result/result-6/loss_lower_m.mat','loss_lower_m');
...
for epsilon_id=1:length(epsilon_allocation_upper)
    ...
    loss_real_m(epsilon_id,1)=1.00859*loss_set1+0.991475*loss_set2+0.736224*loss_set3+1.00261*loss_set4;
end
...
%     end
%     loss_benchmark_m(epsilon_id,1)=1.00859*loss_set1+0.991475*loss_set2+0.736224*loss_set3+1.00261*loss_set4;
% end
% save('result/result-6/loss_benchmark_m.mat','loss_benchmark_m');
save('result/result-6/loss_real_m.mat','loss_real_m');