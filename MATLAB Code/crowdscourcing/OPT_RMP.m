...
for epsilon_id=1:length(epsilon_allocation_upper)
    ...
    loss_OPT_RMP(epsilon_id,1)=1.00859*loss_set1_OPT_RMP+0.991475*loss_set2_OPT_RMP+0.736224*loss_set3_OPT_RMP+1.00261*loss_set4_OPT_RMP;
end

save('result/result-10/loss_OPT_RMP.mat','loss_OPT_RMP');
loss_OPT_RMP_lower=loss_lower;
save('result/result-10/loss_OPT_RMP_lower.mat','loss_OPT_RMP_lower');