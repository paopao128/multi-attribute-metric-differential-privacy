...
load("result/result-1/overall_accuracy_final_ori.mat")
load("result/result-1/overall_accuracy_ori.mat")
load("result/result-1/quality.mat")
...
for attribute_id=1:1:length(attribute_set)
    ...
    % benders
    if Srad_val(1,attribute_id)<0.1
