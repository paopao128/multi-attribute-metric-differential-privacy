...
load("result/result-10/Srad_val.mat")
%% use epsilon_allocation upper
loss_real_r=zeros(length(epsilon_allocation_upper),1);
for epsilon_id=1:length(epsilon_allocation_upper)
    ...
    loss_real_r(epsilon_id,1)=1.00859*loss_set1+0.991475*loss_set2+0.736224*loss_set3+1.00261*loss_set4;
end
...
% end
% save('result/result-10/loss_benchmark_r.mat','loss_benchmark_r');
save('result/result-10/loss_real_r.mat','loss_real_r');