...
load("result/result-10/loss_eval_lower.mat")
load("result/result-10/loss_eval_upper.mat")
...
save('result/result-10/computation_time.mat','computation_time');
save('result/result-10/loss_lower.mat','loss_lower');
save('result/result-10/loss_upper.mat','loss_upper');
save('result/result-10/epsilon_allocation_lower.mat','epsilon_allocation_lower');
save('result/result-10/epsilon_allocation_upper.mat','epsilon_allocation_upper');
