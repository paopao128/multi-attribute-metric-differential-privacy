clear;
load("result/result-7/epsilon_allocation_lower.mat")
load("result/result-7/epsilon_allocation_upper.mat")
load("result/result-7/distance_all_attributes.mat")
load("result/result-7/cost_attribute.mat")
...
for epsilon_id=1:length(epsilon_allocation_upper)
    ...
    loss_BS_PND(epsilon_id,1)=1.00859*loss_set1+0.991475*loss_set2+0.736224*loss_set3+1.00261*loss_set4;
    loss_BS_RMP(epsilon_id,1)=1.00859*loss_set1_BR+0.991475*loss_set2_BR+0.736224*loss_set3_BR+1.00261*loss_set4_BR;
end


save('result/result-7/loss_BS_PND.mat','loss_BS_PND');
save('result/result-7/loss_BS_RMP.mat','loss_BS_RMP');